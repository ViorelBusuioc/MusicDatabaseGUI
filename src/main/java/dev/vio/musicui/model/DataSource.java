...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/viorelbusuioc/IdeaProjects/MusicDB/" + DB_NAME;
        ...
        try {
            ...
            while (results.next()) {
                try {
                    ...
                    System.out.println("E bine boss, eu am oprit sa vad mai bine bara de progress");
                }
            ...
            try {
                ...
                System.out.println("Iar ai facut o prostie. Eroare la incheierea rezultatelor: " + e.getMessage());
            }
            try {
                if (statement != null) {
                    statement.close();
                ...
                System.out.println("Asta-i viata. Ai o eroare bosule la inchierea statmentului: " + e.getMessage());
            }
        }
    }
    ...
    public List<SongArtist> querySongInfoView(String title) {
        ...
        try {
            ...
            System.out.println("Couldn't load query + " + e.getMessage());
            return null;
        }
    }
